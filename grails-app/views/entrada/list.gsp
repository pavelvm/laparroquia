			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="almacen.sucursal.label" default="Sucursal" /></th>
				...
				<g:each in="${almacenInstanceList}" status="i" var="almacenInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${almacenInstance.id}">${fieldValue(bean: almacenInstance, field: "sucursal")}</g:link></td>
